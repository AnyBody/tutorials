...
This tutorial presumes that you have completed the first three lessons on how to
personalize your model using information about height, weight, and individual
segment lengths.
...
```{literalinclude} Snippets/lesson4/snip.Femur.main-1.any
...
```{literalinclude} Snippets/lesson4/snip.Femur.main-2.any
:language: AnyScriptDoc
:start-after: //# BEGIN SNIPPET 1
:end-before: //# END SNIPPET 1
```
...
2. Use the `PickPoints` tool to select points on the surface by right-clicking
   on the desired locations ![PickPoints](_static/lesson5/image4.png)
...
```{literalinclude} Snippets/lesson4/snip.Femur.main-3.any
:language: AnyScriptDoc
:start-after: //# BEGIN SNIPPET 1
:end-before: //# END SNIPPET 1
```
...
You can find the complete model here: {download}`lesson4b.Main.any <Downloads/lesson4b.Main.any>`.
...
```{literalinclude} Snippets/lesson4/snip.Femur.main-4.any
:language: AnyScriptDoc
:start-after: //# BEGIN SNIPPET 1
:end-before: //# END SNIPPET 1
```
...
{doc}`appendix to this tutorial <lesson4_appendix>`. However, for this example, the
recommended settings mentioned before will be used again.

You can download the model with all modifications so far 
{download}`here <Downloads/lesson4c.Main.any>`.
...
```{literalinclude} Snippets/lesson4/snip.Femur.main-5.any
:language: AnyScriptDoc
:start-after: //# BEGIN SNIPPET 1
:end-before: //# END SNIPPET 1
```
