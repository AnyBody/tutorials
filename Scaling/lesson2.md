...
{doc}`Scaling tutorial Lesson 1: Joint to joint scaling methods <lesson1>`. It
...
Here is where our 
[Statistical Scaling Plugin](https://anyscript.org/ammr/beta/Applications/Other/StatisticalScalingPlugin.html)
